...
public class SEGIEditor : Editor
{
	...
	SerializedProperty aggressiveTemporalSampling;
	...
	void OnEnable()
	{
		...
		aggressiveTemporalSampling = serObj.FindProperty("aggressiveTemporalSampling");
	...
	public override void OnInspectorGUI()
	{
		...
		{
			EditorGUI.indentLevel++;
			EditorGUILayout.PropertyField(aggressiveTemporalSampling, new GUIContent("Aggressive Temporal Sampling", "If disabled, temporal sampling is simply a blend of the current and previous frame. If enabled, the GI result is blended across many frames for a less noisy result."));
	...
	void SavePreset(string name)
	{
		...
		preset.aggressiveTemporalSampling = instance.aggressiveTemporalSampling;
