...
Shader "MegaSplat/MegaSplat_ObjectBlend" {
   Properties {
      // triplanar
      _TriplanarContrast("Triplanar Contrast", Range(0.5, 4)) = 2
      _TriplanarTexScale("Triplanar Texture Scale", Float) = 0.1
      _TriplanarOffset("Triplanar Offset", Vector) = (0,0,0,0)
      // Splats
   ...
   SubShader {
      ...
      #define _NORMALMAP 1
      #define _TRIPLANAR 1
      #define _TRIPLANAR_WORLDSPACE 1
      #define _TWOLAYER 1
