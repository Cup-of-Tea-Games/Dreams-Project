...
Shader "MegaSplat/MegaSplat_TessMesh" {
   Properties {
      // Splats
      ...
      #define _TWOLAYER 1
         ...
         float3 DebugSplatOutput(SplatInput si)
         {
                            ...
                            half occlusion, half alpha, float3 viewDir, float4 ambientOrLightmapUV)
            {
                ...
                ugls_en_data.roughness = smoothness;
            ...
            VertexOutput NoTessVert(VertexInput v)
            {
               ...
               worldNormal = normalize(mul(unity_ObjectToWorld, v.normal));
               #endif
            ...
            VertexOutput vert (TessVertex v) 
            {
             ...
             void displacement (inout TessVertex i)
             {
                  ...
                  #if _CUSTOMUSERFUNCTION
                  CustomMegaSplatFunction_PostDisplacement(i.vertex.xyz, offset * i.weights.w, i.normal, i.tangent, i.coords.xy);
                  #else
                  i.vertex.xyz += offset * i.weights.w;
                  #endif
