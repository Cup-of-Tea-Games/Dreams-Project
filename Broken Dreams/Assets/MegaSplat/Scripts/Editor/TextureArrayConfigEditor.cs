...
namespace JBooth.MegaSplat
{
   ...
   public class TextureArrayConfigEditor : Editor 
   {
      ...
      void AssignTexture(TextureArrayConfig cfg, Texture2D tex)
      {
         ...
         if (tex.name.EndsWith(cfg.extHeight))
         {
            var compName = tex.name.Substring(0, tex.name.LastIndexOf("_")).ToLower();
            bool found = false;
         ...
         if (tex.name.EndsWith(cfg.extNorm))
         {
            var compName = tex.name.Substring(0, tex.name.LastIndexOf("_")).ToLower();
            bool found = false;
            for (int i = 0; i < cfg.sourceTextures.Count; ++i)
         ...
         if (tex.name.EndsWith(cfg.extAO))
         {
            var compName = tex.name.Substring(0, tex.name.LastIndexOf("_")).ToLower();
            bool found = false;
            for (int i = 0; i < cfg.sourceTextures.Count; ++i)
         ...
         if (tex.name.EndsWith(cfg.extSmoothness))
         {
            var compName = tex.name.Substring(0, tex.name.LastIndexOf("_")).ToLower();
            bool found = false;
            for (int i = 0; i < cfg.sourceTextures.Count; ++i)
         ...
         if (tex.name.EndsWith(cfg.extEmiss))
         {
            var compName = tex.name.Substring(0, tex.name.LastIndexOf("_")).ToLower();
            bool found = false;
            for (int i = 0; i < cfg.sourceTextures.Count; ++i)
         ...
         if (tex.name.EndsWith(cfg.extAlpha))
         {
            var compName = tex.name.Substring(0, tex.name.LastIndexOf("_")).ToLower();
            bool found = false;
            for (int i = 0; i < cfg.sourceTextures.Count; ++i)
