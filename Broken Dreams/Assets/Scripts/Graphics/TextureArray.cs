...
public class TextureArray : MonoBehaviour
{
    ...
    static void Create()
    {
        ...
        Texture2DArray textureArray = new Texture2DArray(512, 512, slices, TextureFormat.RGBA32, false);
        ...
        for (int i = 1; i <= slices; i++)
        {
            ...
            if(textureArray.GetPixels(i) != null)
        ...
        string path = "Assets/Scripts/Graphics/Export/TextureArrayExport.asset";
